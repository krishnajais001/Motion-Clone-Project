                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-10">
                    ...
                    <div className="md:col-span-4 space-y-4">
                        <div className="border border-black dark:border-white p-6 opacity-30 pointer-events-none">
                            ...
                            <h3 className="text-[14px] font-black uppercase tracking-tight">Strategic Chronology</h3>
                            <p className="text-[10px] font-medium opacity-70">Orchestrate your timeline with zero friction.</p>
                        </div>
                        <div className="border border-black dark:border-white p-6 opacity-30 pointer-events-none">
                             <div className="flex items-center justify-between mb-4">
                                <div className="border border-current p-1"><Timer className="h-4 w-4" /></div>
                            </div>
                            <h3 className="text-[14px] font-black uppercase tracking-tight">Deep Focus Engine</h3>
                            <p className="text-[10px] font-medium opacity-70">Isolate the signal from the noise.</p>
                        </div>
                        <div className="border border-black dark:border-white p-6 opacity-30 pointer-events-none">
                             <div className="flex items-center justify-between mb-4">
                                <div className="border border-current p-1"><PenTool className="h-4 w-4" /></div>
                            </div>
                            <h3 className="text-[14px] font-black uppercase tracking-tight">Spatial Ideation</h3>
                            <p className="text-[10px] font-medium opacity-70">An infinite canvas for thinkers.</p>
                        </div>
                    </div>
